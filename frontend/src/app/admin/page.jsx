...
const menuItems = [
  ...
  { id: "packages", label: "Tour Packages", icon: "🏔️" },
  { id: "destinations", label: "Destinations", icon: "🗺️" },
  { id: "bookings", label: "Bookings", icon: "📅" },
  { id: "customers", label: "Customers", icon: "👥" },
  { id: "blogs", label: "Travel Blogs", icon: "✍️" },
  { id: "gallery", label: "Gallery", icon: "🖼️" },
  { id: "enquiries", label: "Contact Enquiries", icon: "📩" },
...
const managementCards = [
  { icon: "🏔️", title: "Tour Packages", desc: "Manage all trekking & tour packages", color: "bg-green-50", border: "border-green-100" },
  { icon: "🗺️", title: "Destinations", desc: "Add and edit travel destinations", color: "bg-orange-50", border: "border-orange-100" },
  { icon: "📅", title: "Bookings", desc: "View and manage tour bookings", color: "bg-blue-50", border: "border-blue-100" },
  { icon: "👥", title: "Customers", desc: "Customer profiles and history", color: "bg-purple-50", border: "border-purple-100" },
  { icon: "✍️", title: "Travel Blogs", desc: "Create and publish travel blogs", color: "bg-yellow-50", border: "border-yellow-100" },
  { icon: "🖼️", title: "Gallery", desc: "Manage photo and video gallery", color: "bg-pink-50", border: "border-pink-100" },
  { icon: "⭐", title: "Reviews", desc: "Moderate customer reviews", color: "bg-amber-50", border: "border-amber-100" },
  { icon: "📩", title: "Contact", desc: "Handle enquiries and messages", color: "bg-teal-50", border: "border-teal-100" },
  { icon: "🎟️", title: "Coupons", desc: "Create discount codes and offers", color: "bg-rose-50", border: "border-rose-100" },
  { icon: "📊", title: "Analytics", desc: "Revenue and performance metrics", color: "bg-indigo-50", border: "border-indigo-100" },
  { icon: "⚙️", title: "Settings", desc: "Website and account settings", color: "bg-slate-50", border: "border-slate-100" },
];
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
              {managementCards.map((card) => (
                <div
                  key={card.title}
                  className={`group bg-white rounded-3xl shadow-xl border ${card.border} p-5 hover:shadow-2xl hover:-translate-y-1 transition-all duration-200 cursor-pointer`}
                >
                  ...
                  <button className="w-full py-2 rounded-xl bg-[#1B5E20] text-white text-xs font-semibold hover:bg-[#4CAF50] transition-colors duration-200 shadow-sm">
                    Manage →
                  </button>
                </div>
              ))}
